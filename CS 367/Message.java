...
public class Message
{
    ...
    {
    	//a exception if the message lacks some information
    	if(fromNickname == null || fromNickname.isEmpty() || sentTime == null){
    		throw new WhatsAppRuntimeException(Config.CANT_BE_EMPTY_OR_NULL);
    	}
    	//a exception if the toNickname and broadcastNickname both are not null
    	//(two accepters) or both are null(no accepter)
